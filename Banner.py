...
print("""
\33[93;1m            ╔─────── ☠ ☠ ☠ ───────╗\33[39;0m
\33[96;1m𝟏- 𝐔𝐧𝐰𝐨𝐫𝐤 𝐓𝐡𝐢𝐬 𝐓𝐨𝐨𝐥 > 𝐖𝐫𝐢𝐭𝐞 : 𝐚𝐩𝐭 𝐮𝐩𝐝𝐚𝐭𝐞 && 𝐚𝐩𝐭 𝐮𝐩𝐠𝐫𝐚𝐝𝐞\33[39;0m
\33[95;1m𝟐- 𝐅𝐨𝐥𝐥𝐨𝐰 𝐚𝐥𝐥 𝐒𝐭𝐞𝐩𝐬 𝐭𝐨 𝐞𝐱𝐢𝐭 𝐓𝐨𝐨𝐥\33[39;0m
\33[93;1m𝟑- 𝐃𝐨𝐧'𝐭 𝐄𝐝𝐢𝐭 𝐭𝐡𝐢𝐬 𝐓𝐨𝐨𝐥\33[39;0m
\33[92;1m𝟒- 𝐋𝐢𝐧𝐤 𝐎𝐟 𝐆𝐢𝐭𝐡𝐮𝐛 : --⦸⦸..⦸⦸--\33[39;0m
\33[8;1m𝟓- 𝐓𝐡𝐞 𝐓𝐡𝐢𝐬 𝐓𝐨𝐨𝐥 𝐂𝐫𝐞𝐚𝐭𝐞𝐝 𝐁𝐲 𝐏𝐲𝐭𝐡𝐨𝐧 𝐕.𝟑.𝟏𝟐 🇱🇦🇸🇹 🇺🇩🇵🇩🇦🇹🇪...\33[39;0m
\33[91;1m𝟔- 𝐀𝐥𝐥 𝐑𝐢𝐠𝐡𝐭𝐬 𝐑𝐞𝐬𝐞𝐫𝐯𝐞𝐝 𝐭𝐨 𝐭𝐡𝐞 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 
            \33[93;1m╚─────── ☠ ☠ ☠ ───────╝\33[39;0m
""")


for i in tqdm(range(0, 250), ncols = 100,
               desc='\33[39;0m\33[36;1m[\33[39;0m\33[91m-\33[96;1m]\33[39;0m Checking Updates..\33[39;0m',colour='White'):
    time.sleep(.040)
# Progress bar 2: Customized bar format and color
for i in tqdm(range(300),ncols=100,colour='yellow',desc='\33[36;1m[\33[39;0m\33[91m-\33[96;1m]\33[39;0m Code Working... \33[39;0m'):
    time.sleep(0.100)


    time.sleep(0.01)

print("\n\33[39;0m[🚨️]\33[91;1m Enter English Only or any language in not arabic\33[39;0m [🚨]")
print("\33[39;0m[🚨️]\33[91;1m If Not Install Library Please Wait For Download Library to Start Tool...\33[39;0m [🚨]\n")
...
for i in tqdm(range(300),ncols=100,colour='red',desc='\33[36;1m[\33[39;0m\33[91m-\33[96;1m]\33[39;0m Step one..'):
    time.sleep(0.100)
print("﹌" * 20)
...
\33[36;1m[\33[39;0m\33[91;1m0\33[96;1m]\33[39;0m >>> Add a Another Font Type
""")
...
for i in tqdm(range(300),ncols=100,colour='green',desc='\33[36;1m[\33[39;0m\33[91m➡️\33[96;1m]\33[39;0m Step two..'):
    time.sleep(0.150)
print("﹌" * 20)
...
for i in tqdm(range(300),ncols=100,colour='blue',desc='\33[36;1m[\33[39;0m\33[91m➡️\33[96;1m]\33[39;0m Last Step ..'):
    time.sleep(0.80)
...
lsit_number = ['1','2','3','4','5','6']
if set_font_style == '1' :
    banner = ban.figlet_format(set_banner_name,font='slant')

elif set_font_style == '0':

    i = input('\33[36;1m[\33[39;0m\33[91;1m➡️\33[96;1m]\33[39;0m\33[94;2m Add New Font Type (y/n) :| \33[39;0m').lower()
    if i == 'y':
        add_new_font = input('\33[36;1m[\33[39;0m\33[91;1m➡️\33[96;1m]\33[39;0m\33[93;2m Add a New Font Type : ')
        print('\33[31;1mFont Type Not Found\33[39;0m', f"\33[91;1m[{add_new_font}]\33[39;0m")
    ...
    print('\33[91;4m[❌] Error ID number not entered of Font Style \33[39;0m')
...
if set_font_color == '1':
    ...
    print('\n\33[91;4m[❌] Error ID number not entered Of Color \n\33[39;0m')

print("\33[90;3m﹌\33[39;0m" * 25)



user_aked = Write.Input('Do You Want Copy Your Text Banner.. (n/y) : ',Colors.yellow,interval=0).lower()
if user_aked == 'y':
     copy(banner+set_banner_name+set_font_style+set_font_color)
     print('\n\33[92;1mBanner Was Copy in Your clipboard for open this (CTRL + V) \33[39;0m')
