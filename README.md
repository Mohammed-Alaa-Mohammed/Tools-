...
- ```ZPhiers.py <path_to_file> <min_length> <max_length> --use_digits --use_even_digits --num_threads 4``` - Note : ```Use This Tool Use of Windows or Linux only - devices strong... Only```
  ى
